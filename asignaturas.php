        ...
        <div id="content">
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm mb-4 p-3">
                <div class="container-fluid">
                    <span class="navbar-brand mb-0 h4 text-secondary">Gestión de Asignaturas</span>
            ...
            <div class="modal-content">
                <form id="form-asignatura">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalTitulo">Nueva Asignatura</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="nombre" class="form-control" required maxlength="150">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Número de Créditos</label>
                            <input type="number" id="creditos" class="form-control" min="1" max="20" required>
                        </div>
                        <div class="mb-2">
                            <label class="form-label">Titulación</label>
                            <select id="id_titulacion" class="form-select" required>
